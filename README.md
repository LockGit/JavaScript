...
```
![](https://github.com/LockGit/JavaScript/blob/master/install-01.jpeg)
![](https://github.com/LockGit/JavaScript/blob/master/install-02.jpeg)
```
测试：(启用https或者httpOnly需要针对https类型网站）
https://www.baidu.com/
```
![](https://github.com/LockGit/JavaScript/blob/master/install-03.jpeg)
